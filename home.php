...
<section class="home">
   ...
   <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
         ...
         <div class="content">
            <span>FRESH ORGANIC VEGTABLES</span>
            <h3></h3>
...
<section class="category">
   ...
   <a href="category.php?category=Vegtable" class="swiper-slide slide">
      <img src="images/organic.png"  alt="">
      <h3>Vegtable</h3>
   </a>
   ...
   <a href="category.php?category=Greens" class="swiper-slide slide">
      <img src="images/leaf.jpg" alt="">
      <h3>Greens</h3>
   </a>

   <a href="category.php?category=Nuts" class="swiper-slide slide">
      <img src="images/almonds.jpg" alt="">
      <h3>Nuts</h3>
   </a>
   ...
   <a href="category.php?category=agricrafts" class="swiper-slide slide">
